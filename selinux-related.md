# useful SELinux related commands
...
```
$ ls -Z
-rw-r--r--. root    root    unconfined_u:object_r:user_home_t:s0 capture.scap
-rw-r--r--. vagrant vagrant unconfined_u:object_r:user_home_t:s0 dragent.default.yaml
drwxr-x---. vagrant vagrant unconfined_u:object_r:user_home_t:s0 metrics
-rw-r--r--. vagrant vagrant unconfined_u:object_r:user_home_t:s0 p.tgz
drwxr-xr-x. vagrant vagrant unconfined_u:object_r:user_home_t:s0 protoanalyzer
-rwxrwxr-x. vagrant vagrant unconfined_u:object_r:user_home_t:s0 stress-cpu.sh
-rw-r--r--. vagrant vagrant unconfined_u:object_r:user_home_t:s0 sysdig-inspect-latest.x86_64.rpm
-rw-rw-r--. vagrant vagrant unconfined_u:object_r:user_home_t:s0 testfile
-rwxrwxr-x. vagrant vagrant unconfined_u:object_r:user_home_t:s0 what-am-i-running-on.sh
```
